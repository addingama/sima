...
import { ChevronRight, PlusCircleIcon, ReceiptText } from "lucide-react";
...
export function NavMain({ items }: NavMainProps) {
  ...
  const filteredItems = useFilteredSidebarItems(items);
        ...
        <SidebarGroupContent className="flex flex-col gap-2">
          <SidebarMenu>
            <SidebarMenuItem className="flex items-center gap-2">
              <SidebarMenuButton
                asChild
                tooltip="Buat Penerimaan"
                className="min-w-8 bg-primary text-primary-foreground duration-200 ease-linear hover:bg-primary/90 hover:text-primary-foreground active:bg-primary/90 active:text-primary-foreground"
              >
                <Link prefetch={false} href="/dashboard/receipts">
                  <PlusCircleIcon />
              ...
              <Button
                ...
                variant="outline"
              >
                <Link prefetch={false} href="/dashboard/disbursements">
                  <ReceiptText />
